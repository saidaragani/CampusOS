...
/**
 * Builds the security context from the identity headers the gateway injected.
 * The gateway is the only component that validates the JWT; downstream services
 * trust these headers (internal endpoints bypass this and are network-isolated).
 */
@Component
